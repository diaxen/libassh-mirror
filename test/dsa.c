...
int main()
{
  ...
  ASSH_BIGNUM_ALLOC(&context, pn, l, err_);
  ...
  ASSH_BIGNUM_ALLOC(&context, yn, l, err_);
  ...
  ASSH_BIGNUM_ALLOC(&context, xn, n, err_);
  ...
  /* compute R */
  ASSH_BIGNUM_ALLOC(&context, rn, l, err_);
