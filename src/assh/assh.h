...
/* The assh_config.h file must contain the library configuration
   macros described in the @xref{Build configuration} section of the
   manual.  With autotools builds, this is generated by filtering the
   CONFIG_* macros found in the generated config.h file. Other macros
   present in the config.h file are not used in the library source
   code. They are only used in test and example applications. */
...
#elif defined(CONFIG_ASSH_STDIO)
