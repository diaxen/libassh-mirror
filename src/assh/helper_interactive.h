...
struct assh_inter_tcpip_forward_s
{
...
/** @This encodes and sends a port forwarding request
    @csee assh_inter_encode_tcpip_forward
    @see assh_request */
ASSH_WARN_UNUSED_RESULT assh_error_t
...
struct assh_inter_tcpip_forward_reply_s
{
  uint32_t                         port;
};
...
struct assh_inter_cancel_tcpip_forward_s
{
  struct assh_cbuffer_s            addr;
  uint32_t                         port;
};
...
/** @This encodes and sends a port forwarding cancel
    @csee assh_inter_encode_cancel_tcpip_forward
    @see assh_request */
ASSH_WARN_UNUSED_RESULT assh_error_t
...
struct assh_inter_forwarded_tcpip_s
{
...
/** @This requests a incoming forwarded connection channel open.
    @csee assh_inter_encode_forwarded_tcpip
    @see assh_channel_open */
ASSH_WARN_UNUSED_RESULT assh_error_t
...
struct assh_inter_direct_tcpip_s
{
  struct assh_cbuffer_s            conn_addr;
  uint32_t                         conn_port;
  struct assh_cbuffer_s            orig_add;
...
/** @This requests a direct tcp/ip forwarding channel open.
    @csee assh_inter_encode_direct_tcpip
    @see assh_channel_open */
ASSH_WARN_UNUSED_RESULT assh_error_t
